...
class ArbolAVL:
    ...
    def mostrar_arbol(self):
        ...
        nx.draw(grafo, pos, with_labels=True, node_size=2000, node_color="lightgreen", font_size=12, font_weight="bold", arrows=False)
        plt.show()
...
# Ejemplo de uso
arbol_avl = ArbolAVL()
valores = [29, 17, 71, 3, 22, 46, 100, 10, 20, 25, 39, 48, 82, 101]
...
# Eliminar nodos y visualizar los cambios
arbol_avl.eliminar(3)
arbol_avl.eliminar(10)
arbol_avl.eliminar(17)
arbol_avl.eliminar(20)
arbol_avl.eliminar(22)
arbol_avl.eliminar(25)
arbol_avl.eliminar(29)
arbol_avl.eliminar(39)
arbol_avl.mostrar_arbol()
