...
def contar_hijos(arbol):
    if arbol is None:
        return 0
# Contamos el nodo izquierdo y derecho, si existen
    hijos = 0
...
# Suma recursiva de los hijos en subarboles izquierdo y derecho
    return hijos + contar_hijos(arbol.izquierda) + contar_hijos(arbol.derecha)
...
# PROBANDO LA FUNCION
total_hijos =  contar_hijos(raiz)
print ("Numero total de hijos en el arbol: ", total_hijos, " hijos")
